        ...
        <div className="my-10 flex flex-col items-center justify-center px-4">
            ...
            <Card className="w-full max-w-md rounded-xl shadow-sm border border-gray-200 bg-white p-8">
                <Form onSubmit={onSubmit} className="flex flex-col gap-5">
                    ...
                    >
                        ...
                        <div className="relative">
                            <FiUser className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" size={15} />
                            <Input
                    ...
                    >
                        ...
                        <div className="relative">
                            <FiImage className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" size={15} />
                            <Input
                ...
                <p className="text-center text-sm text-gray-400 mt-1">
                    ...
                    <Link href="/login" className="text-[#2AACBB] font-semibold cursor-pointer hover:underline">
                        Sign In
                    </Link>
                </p>
            </Card>
